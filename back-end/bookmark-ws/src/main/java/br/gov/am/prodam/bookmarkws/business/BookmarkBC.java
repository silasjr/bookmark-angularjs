package br.gov.am.prodam.bookmarkws.business;

import java.util.List;

import br.gov.am.prodam.bookmarkws.entity.Bookmark;
import br.gov.am.prodam.bookmarkws.persistence.BookmarkDAO;
